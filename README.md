...
| 0.0.3     | Kernel refactored, command system fixed, added "read" and "uname" commands |
| 0.0.3.1   | Exit command fixed, now it works on qemu (not uploaded) |
| 0.0.4     | 16-bit real mode has been switched to 32-bit protected mode |
...
- Simple command-line shell
  ...
  - `read`  – Attempt to read a disk sector (experimental)
